...
__[Google](https://google.com "Title Text")__


[JS Bangladesh][1] is a dedicated Youtube channel for programming. [JS Bangladesh][2] is an awesome platform to learn programming.   

[1]: <https://jsbangladesh> "Youtube Channel"

[2]: <https://jsbangladesh> "Facebook Group"
...
![Image alt Message](https://instructory.net/assets/images/logo-new-white.png "Image Title")
...
To display an image we use `<img>` tag <br>
`npm install & run dev`

* With out language hint
```
<body>
    <h1>This is H1</h1>
</body>
...
### [Badge making site](https://shields.io/)
